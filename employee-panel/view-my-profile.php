...
<table class="tbl2" width="100%">
	...
	<?php
		...
		$i=0;
		$statement = $db->prepare("SELECT * FROM employee_list WHERE employee_id='$employee_id' ORDER BY employee_id DESC");
		$statement->execute();
		$total_pages = $statement->rowCount();
			...
			$statement = $db->prepare("SELECT * FROM employee_list WHERE employee_id='$employee_id' ORDER BY employee_id DESC LIMIT $start, $limit");
			$statement->execute();
