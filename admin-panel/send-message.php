...
if(isset($_POST['send_message']))
{
	try {
		...
		$statement = $db->prepare("INSERT INTO message(admin_id,sender_name,sender_email,recipent_email,sender_subject,sender_message,send_date,send_status,recipent_status) VALUES(?,?,?,?,?,?,?,?,?) ");
		$statement->execute(array($_POST['admin_id'],$_POST['name'],$_POST['sender_email'],$_POST['email'],$_POST['subject'],$_POST['message'],$send_date,$send_status,$recipent_status));
				...
				?>
					...
					<form action="" method="post" enctype="multipart/form-data">
									...
									<tr><td><input type="hidden" value="<?php echo $_SESSION['admin_id'];?>" name="admin_id"></td></tr>
										...
										<tr>
											<td><input type="hidden" value="<?php echo $_SESSION['email'];?>" name="sender_email"></td>
										</tr>
										<tr>
							...
							<input onclick='return confirm_send();' class="submit_m" type="submit" value="SEND" name="send_message">
