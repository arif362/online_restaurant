...
<table class="tbl2" width="100%">
	...
	<?php
		...
		$i=0;
		$statement = $db->prepare("SELECT * FROM message WHERE recipent_email='$email' and recipent_status='1' ORDER BY message_id DESC");
		$statement->execute();
		$total_pages = $statement->rowCount();
			...
			$statement = $db->prepare("SELECT * FROM message WHERE recipent_email='$email' and recipent_status='1' ORDER BY message_id DESC LIMIT $start, $limit");
			$statement->execute();
			$result = $statement->fetchAll(PDO::FETCH_ASSOC);		
