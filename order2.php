...
if(isset($_POST['add_food']))
{
	...
	try {
		...
		$statement = $db->prepare("INSERT INTO order_list(c_mobile,c_email,c_address,c_account,user_types,food_title,food_id,quantity,total_quantity,food_price,total,payment_types,account,send_date,send_time,month,year,status,confirm_code) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
		$statement->execute(array($_POST['c_mobile'],$_POST['c_email'],$_POST['c_address'],$_POST['c_account'],$customer,$food_title,$food_id,$quantity,$_POST['t_quantity'],$food_price,$_POST['total'],$_POST['payment_types'],$_POST['payment'],$add_date,$add_time,$month,$year,$active,$confirm_code));
		...
		"
		Dear
		Customer, Please Confirm Your Food Order  
...
<td colspan="6" align=right><input type="hidden" name="total" value="<?php echo $item_total; ?>"><strong>Total:</strong> <?php echo 'BDT. '.$item_total; ?></td>
	...
	<tr><td align=left>Mobile No: <input class="short" type="text" name="c_mobile" maxlength="11" placeholder="Mobile No" id="c_mobile"></td><td align=left colspan="6"><span class="error_form" id="mobile_error"></span></td></tr>
	<tr><td align=left>Email No: &nbsp;<input class="short" type="text" name="c_email" placeholder="Email" id="c_email"></td><td align=left colspan="6"><span class="error_form" id="email_error"></span></td></tr>
	<tr><td align=left>Address: <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<textarea name="c_address" placeholder="Address" id="c_address"></textarea></td><td align=left colspan="6"><span class="error_form" id="address_error"></span></td></tr>
