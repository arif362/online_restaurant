...
if(isset($_POST['send_message']))
{
	try {
		...
		$statement = $db->prepare("INSERT INTO message(member_id,sender_name,sender_email,recipent_email,sender_subject,sender_message,send_date,send_status,recipent_status) VALUES(?,?,?,?,?,?,?,?,?) ");
		$statement->execute(array($_POST['member_id'],$_POST['name'],$_POST['sender_email'],$_POST['email'],$_POST['subject'],$_POST['message'],$send_date,$send_status,$recipent_status));
	  ...
	  <div class="section group">
				...
				?>
					    <form name="" action="" method="POST">
							<input type="hidden" value="<?php echo $_SESSION['member_id'];?>" name="member_id">
					    	<div>
