...
<table class="tbl2" width="100%">
	...
	<?php
		...
		$i=0;
		$statement = $db->prepare("SELECT * FROM message WHERE recipent_email='$sub_email' and recipent_status='1' ORDER BY message_id DESC");
		$statement->execute();
		$total_pages = $statement->rowCount();
			...
			$statement = $db->prepare("SELECT * FROM message WHERE recipent_email='$sub_email' and recipent_status='1' ORDER BY message_id DESC LIMIT $start, $limit");
			$statement->execute();
			$result = $statement->fetchAll(PDO::FETCH_ASSOC);		
	...
	{		
		...
		<td>
			...
			&nbsp;|&nbsp;
			<a onclick='return confirm_delete();' href="view-inbox-message.php?message_id=<?php echo $row['message_id']; ?>"><img src="../images/delete.gif"></a>
		</td>
		</tr>
